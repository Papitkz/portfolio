<template>
  <section id="home" class="min-h-screen flex items-center gradient-bg text-white relative overflow-hidden section-transition">
    ...
    <div class="absolute inset-0 overflow-hidden">
      <div v-for="i in 20" :key="i" class="home-particle" 
           :style="{
    ...
    <div class="absolute inset-0 overflow-hidden pointer-events-none">
      <div v-for="(icon, index) in techIcons" :key="index" 
        ...
        <component :is="icon.component" class="w-16 h-16 md:w-24 md:h-24" />
      </div>
    </div>
    ...
    <div class="container mx-auto px-4 sm:px-6 relative z-10">
      <div class="flex flex-col lg:flex-row items-center min-h-screen">
        <div class="w-full lg:w-1/2 mb-10 lg:mb-0 animate-on-scroll fade-in-up py-20 lg:py-0">
          ...
          <h2 class="text-xl sm:text-2xl md:text-3xl font-light mb-6 sm:mb-8 text-cyan-400" style="font-family: 'Orbitron', sans-serif; letter-spacing: 1px sm:letter-spacing: 2px;">
          ...
          <div class="flex flex-wrap gap-4 mb-10">
            <a href="#experience" class="btn btn-enhanced btn-primary text-sm sm:text-base px-6 py-3 flex items-center glass-hover">
              <span>View Experience</span>
              <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
              </svg>
            </a>
            <a href="#contact" class="btn btn-enhanced btn-outline text-sm sm:text-base px-6 py-3 flex items-center glass-hover">
              <span>Contact Me</span>
              <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
              </svg>
            </a>
            <a href="#" @click.prevent="downloadCV" class="btn btn-enhanced btn-primary text-sm sm:text-base px-6 py-3 flex items-center glass-hover">
          ...
          <div class="mt-10 animate-on-scroll fade-in-up" style="animation-delay: 0.4s">
            ...
            <div class="flex flex-wrap gap-3">
              <span v-for="(skill, index) in primarySkills" :key="skill" 
                    class="skill-tag skill-tag-enhanced glass-hover animate-on-scroll fade-in-up"
        ...
        <div class="w-full lg:w-1/2 flex justify-center animate-on-scroll fade-in-up" style="animation-delay: 0.2s">
          <div class="relative">
            ...
            <div class="w-48 h-48 sm:w-56 sm:h-56 md:w-64 md:h-64 lg:w-80 lg:h-80 overflow-hidden rounded-2xl glass-card float-animation">
              <div class="glass-reflection"></div>
              <img src="../assets/Fritz.png" alt="Profile" class="w-full h-full object-cover">
              
              <!-- Animated border -->
              <div class="absolute inset-0 rounded-2xl border-4 border-transparent animate-border">
                <div class="absolute inset-0 rounded-2xl border-4 border-transparent animate-border-inner"></div>
              </div>
            </div>
            
            <!-- Status badge -->
            <div class="absolute -bottom-3 sm:-bottom-4 -right-3 sm:-right-4 bg-gradient-to-br from-cyan-400 to-cyan-600 text-gray-900 p-3 sm:p-4 rounded-xl shadow-lg glass-hover">
              <div class="glass-reflection"></div>
            ...
            <div class="absolute -bottom-3 sm:-bottom-4 -left-3 sm:-left-4 flex space-x-2">
              <a href="https://github.com" target="_blank" class="w-10 h-10 rounded-full bg-gray-900/80 backdrop-blur-sm flex items-center justify-center text-cyan-400 hover:bg-cyan-400 hover:text-gray-900 transition-all duration-300 glass-hover">
                <div class="glass-reflection"></div>
              ...
              <a href="https://linkedin.com" target="_blank" class="w-10 h-10 rounded-full bg-gray-900/80 backdrop-blur-sm flex items-center justify-center text-cyan-400 hover:bg-cyan-400 hover:text-gray-900 transition-all duration-300 glass-hover">
                <div class="glass-reflection"></div>
                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
      ...
      <!-- Scroll indicator -->
      <div class="scroll-indicator hidden sm:block glass-hover">
        <div class="glass-reflection"></div>
...
export default {
  ...
  methods: {
    downloadCV() {
      ...
      link.href = '../assets/JohnFritzIzar_Resume.pdf';
